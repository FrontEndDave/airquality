                ...
                <View style={{ height: "100%", paddingBottom: 150, display: "flex", flexDirection: "column" }}>
                    ...
                    {savedLocations.length === 5 ? (
                        ...
                        <TouchableOpacity
                            ...
                            style={{ width: "100%", height: 70, backgroundColor: "#E8E8E8", marginTop: 15, borderRadius: 20, display: "flex", alignItems: "center", paddingHorizontal: 15, justifyContent: "start", flexDirection: "row" }}>
                            <View style={{ display: "flex", flexDirection: "column" }}>
